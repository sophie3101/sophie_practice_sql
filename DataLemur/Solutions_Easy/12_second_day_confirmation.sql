...
-- Upon sign-up, each user receives a text message confirmation to activate their account.
...
-- Definitions:
-- action_date refers to the date when users activated their accounts and confirmed their sign-up via text messages.
